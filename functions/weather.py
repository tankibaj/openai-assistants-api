...
def get_weather(city):
    ...
    :return: A JSON-formatted string containing the weather information.
    """
    try:
        url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid={config.openweathermap_key}&units=metric"
